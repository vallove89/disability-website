...
export async function getStaticPaths() {
    ...
    const count = await db.collection("parkings").find({}).count()
...
export async function getStaticProps({ params }){
    ...
    let data = await db.collection("parkings").find({}).skip(skip).limit(Config.pagination.pageSize).toArray();
